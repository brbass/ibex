#ifndef Basis_Fission_hh
#define Basis_Fission_hh
...
*/
class Basis_Fission : public Full_Scattering_Operator
{
public:

    // Constructor
    Basis_Fission(std::shared_ptr<Weak_Spatial_Discretization> spatial_discretization,
