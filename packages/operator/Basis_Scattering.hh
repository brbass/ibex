#ifndef Basis_Scattering_hh
#define Basis_Scattering_hh
...
*/
class Basis_Scattering : public Full_Scattering_Operator
{
public:

    // Constructor
    Basis_Scattering(std::shared_ptr<Weak_Spatial_Discretization> spatial_discretization,
