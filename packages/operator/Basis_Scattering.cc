...
Basis_Scattering::
Basis_Scattering(shared_ptr<Weak_Spatial_Discretization> spatial_discretization,
...
{
    AssertMsg(false, "coherent scattering not yet implemented in Basis_Scattering");
}
