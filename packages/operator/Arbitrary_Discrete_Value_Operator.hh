#ifndef Arbitrary_Discrete_Value_Operator_hh
#define Arbitrary_Discrete_Value_Operator_hh
...
class Arbitrary_Discrete_Value_Operator : public Vector_Operator
{
public:

    Arbitrary_Discrete_Value_Operator(std::shared_ptr<Weak_Spatial_Discretization> spatial,
    ...
    {
        return "Arbitrary_Discrete_Value_Operator";
    }
