#ifndef Full_Scattering_Operator_hh
#define Full_Scattering_Operator_hh
...
*/
class Full_Scattering_Operator : public Vector_Operator
{
public:
    ...
    // Constructor
    Full_Scattering_Operator(std::shared_ptr<Weak_Spatial_Discretization> spatial_discretization,
