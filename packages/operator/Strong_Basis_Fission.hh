#ifndef Strong_Basis_Fission_hh
#define Strong_Basis_Fission_hh
...
*/
class Strong_Basis_Fission : public Full_Scattering_Operator
{
public:

    // Constructor
    Strong_Basis_Fission(std::shared_ptr<Weak_Spatial_Discretization> spatial_discretization,
