#ifndef Full_Scattering_hh
#define Full_Scattering_hh
...
*/
class Full_Scattering : public Full_Scattering_Operator
{
public:

    // Constructor
    Full_Scattering(std::shared_ptr<Weak_Spatial_Discretization> spatial_discretization,
